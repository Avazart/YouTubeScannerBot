...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('title', sa.String(), nullable=False),
        sa.ForeignKeyConstraint(['original_chat_id'],
    ...
    op.create_table(
        ...
        sa.Column('telegram_thread_id',
                  sa.Integer(),
                  nullable=True),
        sa.ForeignKeyConstraint(['telegram_chat_id'],
                                ['TelegramChats.original_id'],
                                onupdate='CASCADE',
                                ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['telegram_thread_id'],
                                ['TelegramThreads.id'],
                                onupdate='CASCADE',
                                ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['youtube_channel_id'],
                                ['YouTubeChannels.id'],
                                onupdate='CASCADE',
                                ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
