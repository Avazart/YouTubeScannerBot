...
Revises: 
Create Date: 2023-03-29 20:33:24.525720
...
def upgrade() -> None:
    ...
    op.create_table('YouTubeChannels',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('TelegramThreads',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.Column('original_id', sa.Integer(), nullable=False),
                    sa.Column('original_chat_id', sa.Integer(), nullable=False),
                    sa.Column('title', sa.String(), nullable=False),
                    sa.ForeignKeyConstraint(['original_chat_id'], ['TelegramChats.original_id'], onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('original_id', 'original_chat_id', name='unique_thread')
                    )
    op.create_table('YouTubeChannelTags',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.Column('tag_id', sa.Integer(), nullable=False),
                    sa.Column('channel_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['channel_id'], ['YouTubeChannels.id'], onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['tag_id'], ['Tags.id'], onupdate='CASCADE', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('YouTubeVideos',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.Column('original_id', sa.String(), nullable=False),
                    sa.Column('channel_id', sa.Integer(), nullable=False),
                    sa.Column('title', sa.String(), nullable=False),
    ...
    op.create_table('Forwarding',
                    ...
                    sa.ForeignKeyConstraint(['telegram_chat_id'], ['TelegramChats.original_id'], onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['telegram_thread_id'], ['TelegramThreads.id'], onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['youtube_channel_id'], ['YouTubeChannels.id'], onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('youtube_channel_id', 'telegram_chat_id', 'telegram_thread_id',
